      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            buildTextField(locationController,"Location","unkonw", false),
            SizedBox(
              height: 35,
            ),
            Row(
              ...
              children: [
                ...
                RaisedButton(
                  onPressed: () async{
                    await locator.get<UserController>().UploadInfo(nameController.text);
                    var user = locator.get<UserController>().currentUser;
                    print("name: "+ nameController.text);
                    print(emailController.text);
                    print(locationController.text);
                    await DatabaseService(uid: user.uid).updateUserProfile(nameController.text,emailController.text,locationController.text);
                    },
                  color: Colors.green,
                  padding: EdgeInsets.symmetric(horizontal: 50),
                  elevation: 2,
